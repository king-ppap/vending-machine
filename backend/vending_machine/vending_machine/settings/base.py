"""
Django settings for survey_tu project.
...
WSGI_APPLICATION = 'survey_tu.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'survey_tu.pagination.StandardResultsSetPagination',
